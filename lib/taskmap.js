...
export default function TaskMap( {vc,datecode,selectedPilot,mutatePilots,pilots} ) {
...
function mergePointToPilots( point, pilotsGeoJSON, pilotFullGeoJSON, mapRef, selectedPilot, pilots, mutatePilots ) {
    ...
    // thing being redrawn.
    if( sp.lastUpdated == point.at ) {
        return;
    }
    sp.lastUpdated = point.at;
    sp.delay = (new Date().getTime()/1000) - point.at;
    sp.uptodate = ( sp.delay < 30 );
