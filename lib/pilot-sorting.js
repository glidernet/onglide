...
export function updateSortKeys(trackers,sortKey,units) {
    ...
    function updatePilotSortKey(tracker,sortKey,units) {
        ...
        case 'fspeed':
            ...
            break;
        case 'climb':
            newKey = tracker.average; suffix = units ? 'kt' : 'm'; displayAs = Math.round(newKey*(units? 19.43844 : 10))/10;
            break;
        case 'remaining':
        ...
        case 'height':
            ...
            break;
        case 'aheight':
				newKey = (tracker.agl !== undefined ? Math.round(tracker.agl) : 0); suffix = unitSuffix;
				displayAs = Math.round(newKey * unitConv);
            break;
        case 'start':
            if( tracker.utcstart ) {
        ...
        case 'finish':
            ...
            break;
		case 'duration':
			if( tracker.finish && ! tracker.utcduration ) {
				displayAs = '-';
				suffix = '';
				newKey = '';
			}
        ...
        case 'auto':
            ...
            // Before they start show altitude, sort to the end of the list
                ...
                displayAs = (tracker.agl !== undefined ? Math.round(tracker.agl) * unitConv : 0);
                suffix = unitSuffix;
            }
