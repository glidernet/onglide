...
exports.updateSortKeys = function(trackers,sortKey) {
    ...
    function updatePilotSortKey(tracker,sortKey,units) {
        ...
        case 'ald':
            ...
            break;
        case 'done':
            newKey = Math.max(tracker.hdistancedone, tracker.hdistance); suffix = "km";
            break;
        case 'auto':
            ...
            if( tracker.datafromscoring == 'Y' || tracker.scoredstatus != 'S'  ) {
                if( tracker.scoredstatus == 'D' || tracker.dbstatus == 'D' ) {
                    ...
                    newKey = Math.round(tracker.hdistance,1); displayAs = newKey; suffix = "km";
                }
            }
...
exports.nextSortOrder = function(key,current) {
