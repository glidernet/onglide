...
export function OgnFeed( {vc,datecode,mutatePilots,pilots,selectedPilot,mapRef,tz} ) {
...
function formatTimes(t,tz) {
	...
	return `${dt.toLocaleTimeString( lang, {timeZone: tz, hour: "2-digit", minute: "2-digit"})} (comp), ${dt.toLocaleTimeString(lang,{hour: "2-digit", minute: "2-digit"})} (browser)`;
}
